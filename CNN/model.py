...
import numpy as np
class vgg16:
    def __init__(self, batch_size, output_size, imgs, weights=None, sess=None):
...
#                input_Linear = upsampled_logits
        with tf.variable_scope("Linear"):
            ...
            self.pred = tf.matmul(input_, matrix) + bias
            print "shape of the output: ", self.pred.get_shape()
            self.result = tf.nn.sigmoid(self.pred)
